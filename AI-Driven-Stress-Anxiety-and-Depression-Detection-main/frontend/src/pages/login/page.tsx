    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-white flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-teal-600 hover:text-teal-700 font-medium cursor-pointer">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link to="/signup" className="text-teal-600 hover:text-teal-700 font-medium cursor-pointer">
              Create Account
            </Link>
          </p>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-6 leading-relaxed">
          ...
          This platform provides emotional insights but is not a medical diagnosis tool.
        </p>
      </div>
    </div>
  );
